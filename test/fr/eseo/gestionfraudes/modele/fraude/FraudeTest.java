...
public class FraudeTest {
	...
	private static Collection<Object[]> dtTypes() {
		...
		Object[][] data = new Object[][] {
			{new FraudePapier(d, "desc", "A5", true), TypeFraude.PAPIER},
			{new FraudeCalculatrice(d, "desc", "TI-83", "PROG"), TypeFraude.CALCULATRICE},
			{new FraudeIAG(d, "desc", "ChatGPT"), TypeFraude.IAG},
			{new FraudeIAGConnectee(d, "desc", "Claude", "10.0.0.1"), TypeFraude.IAG_CONNECTEE},
		};
	...
	public void testFraudePapier() {
		FraudePapier papier = new FraudePapier(LocalDate.of(2026, 1, 15), "antiseche", "A6", true);
	...
	public void testFraudeCalculatrice() {
		FraudeCalculatrice calc = new FraudeCalculatrice(LocalDate.of(2026, 1, 15), "prog interdit", "Casio", "ASMPROG");
	...
	public void testFraudeIagConnecteeHerite() {
		FraudeIAGConnectee iagc = new FraudeIAGConnectee(LocalDate.of(2026, 2, 1), "desc", "Gemini", "192.168.1.1");
